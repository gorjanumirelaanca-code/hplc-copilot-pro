...
export default function RetentionPredictionCard() {
    ...
    <div className="rounded-xl border shadow bg-white p-6">
      ...
      <div className="space-y-3">
        ...
        <div className="flex justify-between">
          ...
          <strong>{prediction.retentionTime} min</strong>
        ...
        <div className="flex justify-between">
          ...
          <strong>{prediction.capacityFactor}</strong>
        ...
        <div className="flex justify-between">
          ...
          <strong>{prediction.selectivity}</strong>
        ...
        <div className="flex justify-between">
          ...
          <strong>{prediction.peakWidth} min</strong>
        ...
        <div className="flex justify-between">
          ...
          <strong>{prediction.resolution}</strong>
        ...
        <div className="flex justify-between">
          ...
          <strong>{prediction.tailing}</strong>
